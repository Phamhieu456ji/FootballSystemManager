...
@Injectable()
export class FieldServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: FieldCreateDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Field/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Field/Delete?";
        if (id === null)
     ...
     * @return Success
     */
    edit(body: FieldEditDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Field/Edit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAll(searchTerm: string | undefined): Observable<FieldListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Field/GetAll?";
        if (searchTerm === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<FieldListDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<FieldListDto[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<FieldListDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(FieldListDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<FieldEditDto> {
        let url_ = this.baseUrl + "/api/services/app/Field/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<FieldEditDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<FieldEditDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<FieldEditDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = FieldEditDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class FieldCreateDto implements IFieldCreateDto {
    name: string | undefined;
    status: string | undefined;

    constructor(data?: IFieldCreateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): FieldCreateDto {
        data = typeof data === 'object' ? data : {};
        let result = new FieldCreateDto();
        result.init(data);
        return result;
    }
...
export class FieldEditDto implements IFieldEditDto {
    id: string;
    name: string | undefined;
    status: string | undefined;

    constructor(data?: IFieldEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): FieldEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new FieldEditDto();
        result.init(data);
        return result;
    }
