...
{
    public abstract class FastConnectFootballSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FastConnectFootballSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FastConnectFootballSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FastConnectFootballSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FastConnectFootballSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FastConnectFootballSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FastConnectFootballSystemDbContext, Task<T>> func)
        {
            T result;
