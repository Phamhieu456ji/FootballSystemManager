...
using Shouldly;
using Xunit;
using FastConnectFootballSystem.Sessions;

namespace FastConnectFootballSystem.Tests.Sessions
{
    public class SessionAppService_Tests : FastConnectFootballSystemTestBase
    {
